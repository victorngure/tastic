...
<!-- Mirrored from htmldemo.kimarotec.net/Kwitara-Bootstrap-Real-Estate/html/dark/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jan 2018 08:50:04 GMT -->
<head>
    ...
    <div class="theme-layout">
                                    ...
                                    <div class="contact-form">
                                        <form action="contactFormcode.php" method="post">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <button name="submit" class="flat-btn" type="submit">SEND NOW</button>
                                                </div>
        ...
        <footer>
            <div class="bottom-line">
                <div class="container">
                    <span>Copyright All Right Reserved 2016 <a href="http://wwww.kimarotec.com/" title="">KimaroTec</a></span>
                    <ul>
