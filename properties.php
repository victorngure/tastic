                                ...
                                <div class="properties-sec">
                                    <div class="properties-list">
                                        <div class="filter-wrapper">   
                                            ...
                                            $status = $_POST['status'];
                                            $type = $_POST['value'];
                                            echo '<h4> Displaying results for '.$type.  ' for '.$status; }

                                            else if(($_POST['status']) && (!$_POST['value'])){
                                            $status = $_POST['status'];
                                            echo '<h4> Displaying results for properties for '.$status; }

                                            else if((!$_POST['status']) && ($_POST['value'])){
                                            $status = $_POST['status'];
                                            $type = $_POST['value'];
                                            echo '<h4> Displaying results for '.$type; }?>
                                        ...
                                        <?php
                                            if(($_POST['status']) && ($_POST['value'])){
                                                ...
                                                $sql = "SELECT p.propertyId, p.propertyTitle, p.propertyDescription, p.propertyPrice, p.propertyStatus, p.propertyType, p.bedrooms, p.bathrooms, i1.image, i1.propertyId
                                                    FROM properties p 
                                                ...
                                                if ($result) {
                                                    while($row = $result->fetch_assoc()) {  
                                                        ...
                                                        echo'<div class="to-thumb col-sm-4 p0">';
                                                        echo '<a href="property.php?propertyId=' . $id . '"><img src= "uploads/'.$image.'" width="256" height="235"></a>';   
                                                        echo '<span class="spn-status"> For ' . $status . '</span>';
                                                        echo '<a class="proeprty-sh-more-list" href="property.html"><i class="ti ti-share"> </i></a></div>';
                                                        echo '<div class="to-details col-sm-8 p0">';
                                                        echo '<div class="property-top-cnt">';
                                                        echo '<h3><a href="property.php?propertyId=' . $id . '">' .$name. '</a></h3>';
                                                        echo '<span class="price"> KSh:' .$price. '</span>'; 
                                                        echo '<p>'.$description.'</p></div>';
                                                        echo '<div class="property-bottom-cnt">';
...
<!-- Mirrored from htmldemo.kimarotec.net/Kwitara-Bootstrap-Real-Estate/html/dark/properties2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jan 2018 08:49:42 GMT -->
</html>